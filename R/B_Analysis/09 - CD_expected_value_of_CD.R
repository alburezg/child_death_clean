print(paste0("Running script: ", "9 - CD_expected_value_of_CD"))
...
saveRDS(sum_cl_ex, file = paste0("../../Data/estimates/sum_cl_ex_",fertility_variant,".RDS"))
saveRDS(cl_ex_pop_country, file = paste0("../../Data/estimates/cl_ex_pop_country_",fertility_variant,".RDS"))
