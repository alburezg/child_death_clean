...
# This scipt generates partial tables of child death and child survival estimates
# for including as a pdf in the supplementary materials.

# Equivalent to the tables generated by 8 - supplementary_tables_complete
# but in wide format and for selected birth cohorts and ages only
