...
get_cumulative_child_death_robust <- function(country_keep, reference_years){
  # Get for all four combinations of mortality and fert variants
  
  df_cl_full <- child_loss_robust(
...
if(!exists('df_cl_full')) {
  ...
  saveRDS(df_cl_m_full, paste0('../../Data/estimates/df_cl_m_1950to1999_15to100_',fertility_variant,'.RDS'))
