...
print("tab.2.1_child_death_full saved to ../../Output")
...
print("tab.2.2_child_survival_full.csv saved to ../../Output")
...
print("tab.3.1_child_death_first_diff.csv saved to ../../Output")
...
print("tab.3.2_child_death_burden.csv saved to ../../Output")
...
print("tab.4.1_child_outlive_expected.csv saved to ../../Output")
...
write.csv(datasetS1, "../../Output/datasetS1.csv", row.names = F)
...
print("complete country-level estimates saved to ../../Output")
