...
lex_share_died <-
  ...
  scale_fill_gradientn("Offspring lost (%)",colors= cols, breaks=brks,labels=lab_grad,space="Lab") +
...
ggsave(paste0("../../Output/fig5.pdf"), lex_share_died, width = width, height = height, units = "cm")
