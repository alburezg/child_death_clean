...
cohort_show <- 1955
p_title <- paste0("Women born in ", cohort_show, " and retiring in ", cohort_show + retirement_age)
...
cohort_show <- 1975
p_title <- paste0("Women born in ", cohort_show, " and leaving reproductive age in " , cohort_show + 45)
