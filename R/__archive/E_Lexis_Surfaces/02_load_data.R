...
# Read both datasets from the output generated in the previous scripts

# s1 <- read.csv("../../Output/datasetS1.csv", stringsAsFactors = F)
# 
# # Measures with year-country level
# s2 <- read.csv("../../Output/datasetS1.csv", stringsAsFactors = F)
