...
, and produce the figures and tables, respectively. The scripts in all hree folders needs to be executed in order 
for the figures and tables to be produced and stored in the folder Output.
